...
const menuItems = [
  ...
  { name: 'ตกแต่งหน้าขาย VPN', href: '/admin/server-page-decorator', icon: Palette },
...
const superAdminMenuItems = [
  ...
  { name: 'ธีมสำเร็จรูป', href: '/admin/theme-presets', icon: Sparkles },
  { name: 'Gradient Background', href: '/admin/gradient-background', icon: Palette },
