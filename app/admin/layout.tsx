...
const SUPER_ADMIN_PAGES = ['/admin/server-info', '/admin/super-revenue', '/admin/api-keys', '/admin/api-usage', '/admin/branding', '/admin/theme-editor', '/admin/recaptcha', '/admin/settings', '/admin/menu-settings', '/admin/update-site', '/admin/site-expiry', '/admin/desktop-pet', '/admin/ai-assistant']
